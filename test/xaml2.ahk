...
#Include <maxray\others\Lexikos\winrt.ahk\windows>
...
xg.Content := stk := Windows.UI.Xaml.Markup.XamlReader.Load("
    (
        ...
        <StackPanel xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" Margin="10" Spacing="5" Orientation="Vertical" VerticalAlignment="Top">
            <PasswordBox
            ...
            <Button Content="Toggle reveal mode"/>
        </StackPanel>
    )"
)
